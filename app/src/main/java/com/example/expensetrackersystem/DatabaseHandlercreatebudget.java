...
public class DatabaseHandlercreatebudget extends SQLiteOpenHelper {

    public static final String DATABASE_NAME = "createbudget.db";
    ...
    public DatabaseHandlercreatebudget(@Nullable Context context) {
    ...
    public List<createbudgetModel> getAllIncome() {
        List<createbudgetModel> createbudgetModelList = new ArrayList<>();
        ...
        if (data.getCount() == 0) {
            ...
            if (createbudgetModelList == null) {
                createbudgetModelList = new ArrayList<>();
            }

            while (data.moveToNext()) {
                createbudgetModelList.add(new createbudgetModel(data.getString(0), data.getString(1), data.getString(2), data.getString(3), data.getString(4)));
            }
        }

        return createbudgetModelList;
    }
