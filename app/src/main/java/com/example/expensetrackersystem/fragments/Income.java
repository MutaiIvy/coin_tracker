...
public class Income extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        iv_incomePie.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    public void fillExpense() {
        ...
        incomeAdapter = new incomeAdapter2(getContext(), incomeModelList, databaseHandler);
    ...
    private void init(View view) {
        ...
        iv_incomePie = view.findViewById(R.id.iv_incomePie);
